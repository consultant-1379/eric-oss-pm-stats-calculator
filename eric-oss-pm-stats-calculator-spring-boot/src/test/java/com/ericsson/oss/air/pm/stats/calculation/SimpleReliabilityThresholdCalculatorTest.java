...
class SimpleReliabilityThresholdCalculatorTest {
    ...
    @Spy
    ReliabilityThresholdTemporalAdjuster reliabilityThresholdTemporalAdjuster; /* No point on mocking */

    @InjectMocks
    SimpleReliabilityThresholdCalculator objectUnderTest;
    ...
    void shouldCalculateReliabilityThreshold() {
        ...
        final KpiDefinitionEntity kpiDefinition1 = definitionEntity("kpi1", 60, 60, "identifier_1", "1", "2");
        final KpiDefinitionEntity kpiDefinition2 = definitionEntity("kpi2", -60, 60, "identifier_1", "1", "2");
        final KpiDefinitionEntity kpiDefinition3 = definitionEntity("kpi3", 1_440, 1440, "identifier_2", "1", "2");
        final KpiDefinitionEntity kpiDefinition4 = definitionEntity("kpi4", -1_440, 1440, "identifier_2", "1", "2");
        final KpiDefinitionEntity kpiDefinition5 = definitionEntity("kpi5", 30, 60, "identifier_3", "1", "2");
        final KpiDefinitionEntity kpiDefinition6 = definitionEntity("kpi6", -50, 60, "identifier_3", "1", "2");
        final KpiDefinitionEntity kpiDefinition7 = definitionEntity("kpi7", 60, -1, "identifier_1", "1", "2");
        ...
        final Map<String, LocalDateTime> actual = objectUnderTest.calculateReliabilityThreshold(UUID_1);
        ...
        Assertions.assertThat(actual).containsOnly(
                entry(kpiDefinition1.name(), localDateTime(19, LocalTime.of(11, 0))),
                entry(kpiDefinition2.name(), localDateTime(19, LocalTime.of(13, 0))),
                entry(kpiDefinition3.name(), localDateTime(17, LocalTime.MIDNIGHT)),
                entry(kpiDefinition4.name(), localDateTime(19, LocalTime.MIDNIGHT)),
                entry(kpiDefinition5.name(), localDateTime(18, LocalTime.of(11, 0))),
                entry(kpiDefinition6.name(), localDateTime(18, LocalTime.of(13, 0))),
                entry(kpiDefinition7.name(), localDateTime(19, LocalTime.of(11, 0)))
        );
    }
    ...
    static KpiDefinitionEntity definitionEntity(final String name, final int dataReliabilityOffset, final int aggregationPeriod, final String dataSpace, final String category, final String schemaName) {
        return KpiDefinitionEntity.builder()
                .withName(name)
                .withSchemaDataSpace(dataSpace)
                .withSchemaCategory(category)
                .withSchemaName(schemaName)
                .withDataReliabilityOffset(dataReliabilityOffset)
    ...
    static ReadinessLog readinessLog(final String datasource, final LocalDateTime testTime) {
        return ReadinessLog.builder()
                ...
                .withLatestCollectedData(testTime)
                .build();
    }
}