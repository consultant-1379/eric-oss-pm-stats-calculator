...
class SimpleTableRetentionPeriodTest implements OptionalTableAttributeContract<Integer> {
    ...
    public OptionalTableAttribute<Integer> createInstance() {
        return SimpleTableRetentionPeriod.of(5);
    }
    ...
    @Test
    void testEmpty() {
        SimpleTableRetentionPeriod result = SimpleTableRetentionPeriod.empty();
