...
class SimpleDefinitionExportableTest implements OptionalDefinitionAttributeContract<Boolean> {
    @Override
    public OptionalDefinitionAttribute<Boolean> createInstance() {
        return SimpleDefinitionExportable.of(true);
    }

    @Override
    public TableAttribute<Boolean> createParentInstance() {
        return SimpleTableExportable.of(false);
    }
