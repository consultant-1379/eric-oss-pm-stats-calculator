...
public interface RequiredTableAttributeContract<T> extends RequiredAttributeContract<T> {
    int REQUIRED_TABLE_ATTRIBUTE_CONTRACT_ORDER = REQUIRED_ATTRIBUTE_CONTRACT_ORDER + 1_000;

    @Override
    RequiredTableAttribute<T> createInstance();

    @TestFactory
    @DisplayName("Deserialization")
    @Order(REQUIRED_TABLE_ATTRIBUTE_CONTRACT_ORDER + 1)
