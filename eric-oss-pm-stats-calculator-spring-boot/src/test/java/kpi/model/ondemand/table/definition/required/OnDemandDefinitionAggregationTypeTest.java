...
class OnDemandDefinitionAggregationTypeTest implements RequiredDefinitionAttributeContract<AggregationType> {
    @Override
    public RequiredDefinitionAttribute<AggregationType> createInstance() {
        return OnDemandDefinitionAggregationType.of(AggregationType.SUM);
    }
