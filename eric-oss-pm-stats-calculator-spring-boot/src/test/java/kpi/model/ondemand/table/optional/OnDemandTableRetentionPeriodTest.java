...
class OnDemandTableRetentionPeriodTest implements OptionalTableAttributeContract<Integer> {
    ...
    public OptionalTableAttribute<Integer> createInstance() {
        return OnDemandTableRetentionPeriod.of(5);
    }
    ...
    @Test
    void testEmpty() {
        OnDemandTableRetentionPeriod result = OnDemandTableRetentionPeriod.empty();
