...
public class ComplexTableAggregationElementsTest implements RequiredTableAttributeContract<List<ComplexAggregationElement>> {

    @Override
    public RequiredTableAttribute<List<ComplexAggregationElement>> createInstance() {
        return ComplexTableAggregationElements.of(toComplexAggregationElements("table.column", "table.column1 AS column1"));
    }
