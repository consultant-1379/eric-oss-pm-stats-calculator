...
class ComplexDefinitionDataLookBackLimitTest implements OptionalDefinitionAttributeContract<Integer> {
    @Override
    public OptionalDefinitionAttribute<Integer> createInstance() {
        return ComplexDefinitionDataLookBackLimit.of(10);
    }

    @Override
    public TableAttribute<Integer> createParentInstance() {
        return ComplexTableDataLookBackLimit.of(60);
    }
