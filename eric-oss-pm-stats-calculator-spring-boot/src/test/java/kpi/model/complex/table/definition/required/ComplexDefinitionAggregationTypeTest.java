...
class ComplexDefinitionAggregationTypeTest implements RequiredDefinitionAttributeContract<AggregationType> {
    @Override
    public RequiredDefinitionAttribute<AggregationType> createInstance() {
        return ComplexDefinitionAggregationType.of(AggregationType.SUM);
    }
