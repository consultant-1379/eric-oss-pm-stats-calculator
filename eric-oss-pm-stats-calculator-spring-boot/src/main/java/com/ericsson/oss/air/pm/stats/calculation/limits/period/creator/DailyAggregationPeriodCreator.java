...
@Slf4j
@ApplicationScoped
public class DailyAggregationPeriodCreator implements AggregationPeriodCreator {
    @Override
    ...
    public ComplexAggregationPeriod createComplexAggregation(final LocalDateTime lowerReadinessBound, final LocalDateTime upperReadinessBound) {
        final LocalDateTime calculationStart = lowerReadinessBound.truncatedTo(ChronoUnit.DAYS);
        final LocalDateTime reliabilityThreshold = upperReadinessBound.truncatedTo(ChronoUnit.DAYS);
    ...
    public AggregationPeriod create(@NonNull final LocalDateTime lowerReadinessBound) {
        final LocalDateTime periodStart = lowerReadinessBound.truncatedTo(ChronoUnit.DAYS);
