...
public class ExpressionUnresolvedNamedLambdaVariable extends ExpressionVisit {
    public ExpressionUnresolvedNamedLambdaVariable(final Expression expression) {
        super(expression);
    }
