...
public interface ReliabilityThresholdCalculatorRegistryFacade {

    ReliabilityThresholdCalculator calculator(final Collection<KpiDefinitionEntity> definitions);
}
