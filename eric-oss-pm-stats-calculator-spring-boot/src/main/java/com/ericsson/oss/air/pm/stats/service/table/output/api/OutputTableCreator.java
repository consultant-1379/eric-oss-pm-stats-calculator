...
public interface OutputTableCreator {
    /**
     * Create output table for {@link KpiDefinitionEntity}s.
     *
     ...
     */
    void createOutputTable(TableCreationInformation tableCreationInformation, Map<String, KpiDataType> validAggregationElements);
}
