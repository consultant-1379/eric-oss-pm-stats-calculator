...
import static com.ericsson.oss.air.pm.stats.common.spark.launcher.SparkLauncherConfiguration.POST_SPARK_EXECUTION_WAIT_TIME;
import static com.ericsson.oss.air.pm.stats.common.spark.launcher.SparkLauncherConfiguration.POST_SPARK_EXECUTION_WAIT_TIME_UNIT;
...
public abstract class AbstractSparkLauncher implements Callable<SparkAppHandle.State> {
     ...
     *
     * @param applicationHomeDirectory
     *            The location to use
     */
     ...
     *
     * @param applicationId
     *            The application ID used in the log
     ...
     * @throws Exception
     *             if there is an issue launching the Spark job
     */
    @Override
