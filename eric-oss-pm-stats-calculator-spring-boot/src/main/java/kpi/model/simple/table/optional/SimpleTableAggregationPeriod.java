...
public class SimpleTableAggregationPeriod extends OptionalTableAttribute<Integer> implements AggregationPeriodAttribute {

    private SimpleTableAggregationPeriod(final Integer value) {
        super(value);
    }

    @JsonCreator
    public static SimpleTableAggregationPeriod of(@JsonProperty(Attributes.ATTRIBUTE_AGGREGATION_PERIOD) final Integer value) {
        return new SimpleTableAggregationPeriod(value);
    }
