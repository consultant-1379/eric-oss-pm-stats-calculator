...
public class SimpleDefinitionName extends RequiredDefinitionAttribute<String> implements NameAttribute {

    private SimpleDefinitionName(final String value) {
        super(value);
    }

    @JsonCreator
    public static SimpleDefinitionName of(@JsonProperty(value = Attributes.ATTRIBUTE_NAME, required = true) final String value) {
        return new SimpleDefinitionName(value);
    }
