...
public class SimpleTableExportable extends OptionalTableAttribute<Boolean> implements ExportableAttribute {

    private SimpleTableExportable(final Boolean value) {
        super(value);
    }

    @JsonCreator
    public static SimpleTableExportable of(@JsonProperty(Attributes.ATTRIBUTE_IS_EXPORTABLE) final Boolean value) {
        return new SimpleTableExportable(value);
    }
