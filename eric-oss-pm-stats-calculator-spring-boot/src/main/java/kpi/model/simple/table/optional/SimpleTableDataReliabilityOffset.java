...
public class SimpleTableDataReliabilityOffset extends OptionalTableAttribute<Integer> implements DataReliabilityOffsetAttribute {

    private SimpleTableDataReliabilityOffset(final Integer value) {
        super(value);
    }

    @JsonCreator
    public static SimpleTableDataReliabilityOffset of(@JsonProperty(Attributes.ATTRIBUTE_DATA_RELIABILITY_OFFSET) final Integer value) {
        return new SimpleTableDataReliabilityOffset(value);
    }
