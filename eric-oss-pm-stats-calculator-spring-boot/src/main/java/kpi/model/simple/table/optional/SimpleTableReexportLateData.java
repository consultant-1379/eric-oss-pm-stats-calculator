...
public class SimpleTableReexportLateData extends OptionalTableAttribute<Boolean> implements ReexportLateDataAttribute {

    private SimpleTableReexportLateData(final Boolean value) {
        super(value);
    }

    @JsonCreator
    public static SimpleTableReexportLateData of(@JsonProperty(Attributes.ATTRIBUTE_REEXPORT_LATE_DATA) final Boolean value) {
        return new SimpleTableReexportLateData(value);
    }
