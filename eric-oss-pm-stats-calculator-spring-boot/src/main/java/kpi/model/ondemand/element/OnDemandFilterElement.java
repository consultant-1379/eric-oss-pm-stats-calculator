...
public class OnDemandFilterElement extends ElementBase<String> implements FilterElement {

    private OnDemandFilterElement(final String value) {
        super(value);
    }

    @JsonCreator
    public static OnDemandFilterElement of(final String value) {
        return new OnDemandFilterElement(value);
    }
