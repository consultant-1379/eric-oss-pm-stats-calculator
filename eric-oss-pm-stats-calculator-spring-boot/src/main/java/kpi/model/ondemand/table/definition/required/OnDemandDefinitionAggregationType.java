...
public class OnDemandDefinitionAggregationType extends RequiredDefinitionAttribute<AggregationType> implements AggregationTypeAttribute {

    private OnDemandDefinitionAggregationType(final AggregationType value) {
        super(value);
    }

    @JsonCreator
    public static OnDemandDefinitionAggregationType of(
            @JsonProperty(value = Attributes.ATTRIBUTE_AGGREGATION_TYPE, required = true) final AggregationType value
    ) {
        return new OnDemandDefinitionAggregationType(value);
    }
