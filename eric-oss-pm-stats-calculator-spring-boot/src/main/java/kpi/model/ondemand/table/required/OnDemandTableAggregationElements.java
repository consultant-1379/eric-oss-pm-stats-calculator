...
public class OnDemandTableAggregationElements
        extends RequiredTableAttribute<List<OnDemandAggregationElement>>
        implements AggregationElementsAttribute<OnDemandAggregationElement> {

    private OnDemandTableAggregationElements(final List<OnDemandAggregationElement> value) {
        super(value);
    }

    @JsonCreator
    public static OnDemandTableAggregationElements of(
            @JsonSetter(contentNulls = Nulls.FAIL)
            @JsonProperty(value = Attributes.ATTRIBUTE_AGGREGATION_ELEMENTS, required = true) final List<OnDemandAggregationElement> value
    ) {
        return new OnDemandTableAggregationElements(value);
    }
    ...
    @Override
    protected ValidationResult validateValue(final List<OnDemandAggregationElement> value) {
