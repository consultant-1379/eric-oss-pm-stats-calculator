...
import static kpi.model.util.ValidationResults.paramValueContainsOnlyEndOrStartTime;
...
public class ComplexFilterElement extends ElementBase<String> implements FilterElement {

    private ComplexFilterElement(final String value) {
        super(value);
    }

    @JsonCreator
    public static ComplexFilterElement of(final String value) {
        return new ComplexFilterElement(value);
    }
    ...
    protected ValidationResult validateValue(final String value) {
        return super.validateValue(value)
                ...
                .andThen(() -> paramValueContainsOnlyEndOrStartTime(name(), value))
