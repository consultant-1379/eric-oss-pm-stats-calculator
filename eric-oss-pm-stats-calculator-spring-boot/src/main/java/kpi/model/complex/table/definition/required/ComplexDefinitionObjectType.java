...
public class ComplexDefinitionObjectType extends RequiredDefinitionAttribute<ObjectType> implements ObjectTypeAttribute {

    private final String originalValue;

    private ComplexDefinitionObjectType(final String value) {
        super(ObjectType.from(value));
        this.originalValue = value;
    }

    @JsonCreator
    public static ComplexDefinitionObjectType of(@JsonProperty(value = Attributes.ATTRIBUTE_OBJECT_TYPE, required = true) final String value) {
        return new ComplexDefinitionObjectType(value);
    }
