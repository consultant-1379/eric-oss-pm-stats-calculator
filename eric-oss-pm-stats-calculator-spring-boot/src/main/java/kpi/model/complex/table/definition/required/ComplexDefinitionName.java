...
public class ComplexDefinitionName extends RequiredDefinitionAttribute<String> implements NameAttribute {

    private ComplexDefinitionName(final String value) {
        super(value);
    }

    @JsonCreator
    public static ComplexDefinitionName of(@JsonProperty(value = Attributes.ATTRIBUTE_NAME, required = true) final String value) {
        return new ComplexDefinitionName(value);
    }
