...
*/ -}}
{{- define "eric-oss-pm-stats-calculator.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-pm-stats-calculator.mergeAnnotations" -}}
  {{- include "eric-oss-pm-stats-calculator.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-pm-stats-calculator.mergeLabels" -}}
  {{- include "eric-oss-pm-stats-calculator.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
