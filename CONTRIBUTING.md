# Contributing to Main calculation service in the PM Stats Calculation Handling application. This is to read PM data from Kafka and calculate KPIs based on definitions provided by the auto apps
