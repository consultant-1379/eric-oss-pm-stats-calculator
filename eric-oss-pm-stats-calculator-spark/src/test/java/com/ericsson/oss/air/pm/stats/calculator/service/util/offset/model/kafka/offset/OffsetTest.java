...
class OffsetTest {
    ...
    void shouldCompareTo(final Offset left, final Offset right, final int expected) {
    ...
    static Stream<Arguments> provideCompareToData() {
        return Stream.of(
                Arguments.of(Offset.of(0), Offset.of(1), -1),
                Arguments.of(Offset.of(1), Offset.of(1), 0),
                Arguments.of(Offset.of(1), Offset.of(0), 1)
        );
    }
}