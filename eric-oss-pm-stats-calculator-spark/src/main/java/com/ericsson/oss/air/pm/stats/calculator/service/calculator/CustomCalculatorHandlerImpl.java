...
public class CustomCalculatorHandlerImpl implements CalculatorHandler {
    ...
    public KpiCalculator calculator(final Collection<KpiDefinition> kpiDefinitions) {
        ...
        return new KpiCalculatorCustomFilter(sparkService, sqlProcessorDelegator, aggregationPeriod, kpiDefinitions, sparkSession);
    }
