...
import com.ericsson.oss.air.pm.stats.test.tools.producer.facts.pmcounters.PmCounterFactTestNamespace;
...
@Getter
@Setter
public class FactTestNamespace {
    ...
    private PmCounterFactTestNamespace pmCounters;
}
