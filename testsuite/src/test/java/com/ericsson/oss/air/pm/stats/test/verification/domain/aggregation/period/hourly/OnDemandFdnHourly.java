...
/**
 * Class representing <strong>kpi_on_demand_fdn_60</strong> table.
 */
@Data
@Builder
public final class OnDemandFdnHourly implements DatabaseRow {
    ...
    @FieldToInspect(fieldName = "onDemandFdnFilter")
    private final Long onDemandFdnFilter;
