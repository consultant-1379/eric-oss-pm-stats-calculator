...
/**
 * Class representing <strong>kpi_sector_1440</strong> table.
 */
@Data
@Builder
public final class KpiSectorDaily implements DatabaseRow {
    ...
    @FieldToInspect(fieldName = "maxInteger1440KpiDb")
    private final Integer maxInteger1440KpiDb;
