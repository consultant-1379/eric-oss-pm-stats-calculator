...
package com.ericsson.oss.air.pm.stats.test.verification.domain.aggregation.period.none.complex;
...
/**
 * Class representing <strong>kpi_complex_</strong> table.
 */
@Data
@Builder
public class KpiComplexNone implements DatabaseRow {
    ...
    @Default
    @FieldToInspect(fieldName = "sumIntegerComplex")
    private final Integer sumIntegerComplex = 1;
}
