...
/**
 * Class representing <strong>kpi_simple_fdn_cell_60</strong> table.
 */
@Data
@Builder
public final class SimpleFdnCellHourly implements DatabaseRow {
    ...
    @FieldToInspect(fieldName = "simpleFdnExpr")
    private final String simpleFdnExpr;
